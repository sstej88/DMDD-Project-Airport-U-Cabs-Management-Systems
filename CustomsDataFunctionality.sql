...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('OFFICER WITH NAME '||INPUT_OFFICER_NAME||' IS NOT INSERTED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('OFFICER CANNOT BE VALIDATED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('PASSENGER ADDITION CANNOT BE DONE DUE TO EXCEPTION');
END;
