...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('PASSENGER NAME EXTRACTION EXCEPTION OCCURED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('PASSENGER DESTINATION EXTRACTION EXCEPTION OCCURED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('CAB DETAILS EXTRACTION EXCEPTION OCCURED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('DATA INSERTION IN AIRPORT TAXI BOOKING MACHINE HAS AN EXCEPTION');
END;
