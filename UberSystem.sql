...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('PASSENGER NAME IS NOT VERIFIED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('PASSENGER DESTINATION IS NOT VERIFIED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('CAB NUMBER IS NOT VERIFIED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('DRIVER ID IS NOT VERIFIED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('CAB SERVICE NAME IS NOT VERIFIED');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('CANNOT ADD TO THE UBER SERVICES');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('CANNOT VERIFY CAB READINESS');
END;
...
BEGIN
    ...
    EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('UBER SERVICES TRIGGER CANNOT BE EXECUTED DUE TO EXCEPTION');
END;
